...
internal class Program
{
    ...
    public static void Main(string[] args)
    {
        if (args.Length < 6) 
        {
            ...
            {
                args = "NetOS -a0x100000 -camd64 -felf -tiso -ooutput.iso ConsoleApp1.dll".Split(" ");
                goto DebugStart;
            }

            Console.WriteLine("Usage: NetOS -a<address> -c<amd64> -f<bin,elf> -t<none,iso> -o<output> <input>");
            Environment.Exit(1);
        }
        DebugStart:
